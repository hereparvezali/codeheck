        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(small_integer_null(Problems::TimeLimit).default(1000))
                    .col(small_integer_null(Problems::MemoryLimit).default(256))
                    .col(string_null(Problems::Difficulty).string_len(8))
                    .col(boolean_null(Problems::IsPublic).default(false))
                    .col(timestamp_null(Problems::CreatedAt).default(Expr::current_timestamp()))
